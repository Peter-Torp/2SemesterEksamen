...
public class DeleteCustomer extends JPanel {
	...
	public DeleteCustomer() {
		...
		JLabel lblDeleteCustomer = new JLabel("Slet Kunde");
		lblDeleteCustomer.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblDeleteCustomer.setForeground(Color.WHITE);
		lblDeleteCustomer.setBounds(12, 11, 121, 16);
		...
		btnSearchCustomer.setBounds(230, 79, 110, 25);
