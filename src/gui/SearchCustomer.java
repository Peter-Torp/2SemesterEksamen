...
public class SearchCustomer extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5218403431759238972L;
	...
	public SearchCustomer() {
		...
		JLabel lblSearchCustomer = new JLabel("S\u00F8g Kunde");
		lblSearchCustomer.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblSearchCustomer.setForeground(Color.WHITE);
		lblSearchCustomer.setBounds(12, 11, 121, 16);
